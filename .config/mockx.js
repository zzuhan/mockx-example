module.exports = {
	domains: ["ju.taobao.com", "api.taobao.com"],
	mockDir: "../",
	rules: [
	// 基础用法
	// =====================================
	...
	// 简单的json文件 返回json数据
	{
		"route": "/api/userinfoByJSON",
		"json": "mock/userinfo.json"
	},

	// 当需要jsonp类型 返回自动包裹jsonp格式
	{
		"route": "/api/userinfoWrapByJSONP",
		"json": "mock/userinfo.json",
		"jsonp": "callback"
	},
	...
	{
		"route": "/api/userinfoByJS",
		"jsData": "mock/userinfo.js"
	},

	// 简单的remote 返回远程remote返回的数据
	{
		"route": "/api/mockxRemote",
		"remote": "http://dip.alibaba-inc.com/api/v2/services/schema/mock/7222"
	},

	// 正则支持
	// http://localhost/api/78878/info -> mock/78878.json
	{
		"route": /\/api\/(\d{5,10})\/info/i,
		// $1 匹配上面第一个匹配的
		"json": "mock/$1.json"
	},
	...
	// // 将会转义为
	{
  	...
  	// https://ju.taobao.com/tg/brand_items.htm?act_sign_id=14541818&seller_id=749901026
  	{
  		...
  		"host": "ju.taobao.com",
  		"file": "mock/map_html.html"
  	},

  	// 场景4 不同的query返回不同的内容
  	// http://localhost/tg/get_good_info.htm?itemId=-1
  	{
  		"route": "/tg/get_good_info.htm",
  		"data": {
  			"itemId": "-1"
  		},
  		"json": "mock/get_good_info_fail.json"
  	},

  	// http://localhost/tg/get_good_info.htm?itemId=1234567
  	{
  		"route": "/tg/get_good_info.htm",
  		"data": {
  			"itemId": "1234567"
  		},
  		"json": "mock/get_good_info_success.json"
  	},

  	// 场景5 一个list数据，不想每页的数据都是一样的
  	{
  		"route": "/tg/get_items.htm",
  		"json": "mock/mockjs.json"
  	},
